...
import Carousel1 from "@/public/assets/images/carouselSection3/carousel-1.webp";
import { ArrowRightIcon } from "@heroicons/react/24/outline";

export const CarouselItem1: React.FC = () => {
  return (
    <div className="flex flex-col-reverse sm:flex-row items-center w-full h-full">
      <div className="w-full sm:w-[48%] sm:pr-[10px] sm:mb-0 md:pr-[91px] mb-10 h-full">
        <div className="mt-7 sm:mt-0 text-[24px] font-bold text-[#334455]">
          Escale seu negócio <br /> mantendo as finanças organizadas
        </div>

        <div className="mt-7mb-7 font-medium text-darksilver mt-5">
          Um sistema com informações centralizadas, conciliando rotinas
          burocráticas com relatórios de saúde do negócio, tendo uma melhor
          previsibilidade de lucros e clareza na tomada de decisão. Backups
          automáticos de maneira recorrente e otimizada, com toda segurança de
          dados.
        </div>
